...
int main()
{
    ...
    {   max=0.000000001;
        y[0] =200*x[0]+250*x[0]*x[0]-350;
        y[1] =600*x[0]*x[0]+250*x[1]*x[1]+(50/3)*x[0]*x[0]*x[0]+(100/3)*x[1]*x[1]*x[1]-500*x[0]*x[1]+100*x[0]*x[0]*x[1]-100*x[0]*x[1]*x[1]-350*x[1];

        y_d[0][0] = 200+500*x[0];
        y_d[0][1] =0;
        y_d[1][0] =1200*x[0]+100*x[1]*x[1]-500*x[0]+200*x[0]*x[1]-100*x[1]*x[1];
        y_d[1][1] =500*x[1]+100*x[1]*x[1]-500*x[0]+100*x[0]*x[0]-200*x[0]*x[1]-350;
